# Backend API - Laboratorium 2

**Autor:** Kinga
**Grupa:** INMN2(hybryda)_PAW2

## Opis projektu
Rozwój poprzedniego zadania o połączenie z bazą danych (Supabase/PostgreSQL) oraz dodanie autoryzacji użytkowników w oparciu o JWT tokeny przez Supabase Auth.
